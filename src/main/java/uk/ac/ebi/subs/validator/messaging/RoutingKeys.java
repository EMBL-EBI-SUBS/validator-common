...
public class RoutingKeys {
    ...
    public static final String EVENT_ENA_ASSYADATA_CREATED = "ena.assaydata.created";
    public static final String EVENT_ENA_ASSYADATA_UPDATED = "ena.assaydata.updated";
